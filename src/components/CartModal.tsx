...
const CartModal: React.FC<{ isVisable: boolean; onCartClick: (data: boolean) => void }> = (props) => {
  ...
  const [isSendingRequest, setIsSendingRequest] = useState(false); // [1
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="bg-custom-gray w-[calc(60vw)] h-[calc(60vh)] rounded-md overflow-y-auto">
          {totalCartPrice === "0.00" ? (
              ...
              <div className="self-end flex flex-rwo items-center p-5">
                ...
                >
                  {isSendingRequest ? (
                    <svg
                      aria-hidden="true"
                      className="inline w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-red-900"
                      viewBox="0 0 100 101"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
